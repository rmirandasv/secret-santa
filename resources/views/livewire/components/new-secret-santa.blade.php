<div x-data="newSecretSanta($wire)" class="max-w-xl w-full mx-auto flex flex-col">
  <form wire:submit="save">
    ...
    <div x-cloak x-show="step === 1" class="p-4 flex flex-col justify-between">
      ...
      <div class="mt-10">
        <button type="button" class="w-full px-4 py-2 text-sm font-medium text-white bg-blue-500 rounded-md disabled:opacity-50"
    ...
    <div x-cloak x-show="step === 2" class="p-4">
      <div class="flex flex-col space-y-2">
        ...
        <div class="flex flex-col">
          ...
          <textarea id="message" name="message" x-model="message"
            class="p-2 block w-full mt-1 text-gray-600 border border-gray-300 rounded-md focus:outline-indigo-500 focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm"></textarea>
      ...
      <div class="mt-10 flex items-center space-x-4">
        ...
        <button type="submit" class="w-full px-4 py-2 text-sm font-medium text-white bg-blue-500 rounded-md disabled:opacity-50"
