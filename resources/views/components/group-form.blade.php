<div class="flex flex-col space-y-4">
    ...
    <div class="flex flex-col space-y-2">
        ...
        <input type="date" id="gift_exchange_date" wire:model="form.gift_exchange_date" class="p-2 border border-gray-300 rounded-md focus:outline-none focus:ring focus:ring-blue-200">
